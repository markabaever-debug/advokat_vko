...
export const metadata: Metadata = {
  title: "Адвокат в Усть-Каменогорске ВКО",
  description:
    "Адвокат Маркабаев Ерлан Бапашевич: уголовные и гражданские дела, семейные споры, документы, представительство в суде. WhatsApp/Telegram: 87775430791.",
